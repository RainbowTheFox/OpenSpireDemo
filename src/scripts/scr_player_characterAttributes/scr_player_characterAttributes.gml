...
{
	var prefix_length = string_length(argument1);
	var sprite_name = string_delete(sprite_get_name(argument0), 1, prefix_length + 3);
	var asset_string = string("{0}{1}_{2}", argument1, scr_getCharacterPrefix(argument2), sprite_name);
...
function define_player_palette(argument0 = 0, argument1, argument2, argument3 = argument2, argument4 = argument3, argument5 = undefined)
{
	var q = [];
	
	if (array_length(global.CharacterPalette[argument0].palettes))
	{
		var _ref = global.CharacterPalette[argument0].palettes[0].palColors;
...
define_palette_sprite(0, [0, 1]);
define_player_palette(0, "palette_PZ_default", 4259839, 3979494, 2631776, undefined, 13773959, 3736096, 9988216, 8628991, 14496);
define_player_palette(0, "palette_PZ_classic", 16777215, 13150344, 13150344, undefined);
define_player_palette(0, "palette_PZ_exhibitionnight", 12105936, 6907567, 2631776, undefined);
define_player_palette(0, "palette_PZ_exhibitionred", 12512, 88, 88, undefined);
define_player_palette(0, "palette_PZ_exhibitionblack", 4800062, 2629656, 2629656, undefined);
define_player_palette(0, "palette_PZ_exhibitionpurple", 11230063, 7220541, 7220541, undefined, 9437384, 4194448, 12105936);
define_player_palette(0, "palette_PZ_noise", 8446200, 1607896, 1607896, undefined, 1607896, 14496, 14496);
define_player_palette(0, "palette_PZ_exhibitionbrain", undefined, 0, 4528756, spr_demopattern_brain, 6301864, 3670136, 3670136);
define_player_palette(0, "palette_PZ_exhibitionbraingold", undefined, 0, 88, spr_demopattern_brainGold, 12436, 2106960, 2106960);
define_player_palette(0, "palette_PZ_exhibitionpaper", undefined, 0, 16296056, spr_demopattern_paper, 16298128, 13660176, 13660176);
define_player_palette(0, "palette_PZ_exhibitionentryway", undefined, 0, 37088, spr_demopattern_entryway, 3160248, 2631776, 2631776);
define_player_palette(0, "palette_PZ_exhibitionsteamy", undefined, 0, 16375551, spr_demopattern_steamy, 11042984, 15743104, 9461864);
define_player_palette(0, "palette_PZ_exhibitionmineshaft", undefined, 0, 8340489, spr_demopattern_mineshaft, 4771936, 5793792, 5793792);
define_player_palette(0, "palette_PZ_exhibitionmolasses", undefined, 0, 5793792, spr_demopattern_molasses, 1601784, 12464, 12464);
