function state_player_Sjump()
{
	...
	else if ((key_attack2 || inputBufferSlap > 0) && global.playerCharacter == 0 && sprite_index != spr_player_PZ_fall_outOfControl && sprite_index != spr_superspring && sprite_index != spr_superjumpCancelIntro)
	{
