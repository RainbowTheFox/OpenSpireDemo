...
{
	var arg0 = scr_parseBool(string(argument0[1]), !global.panic);
...
{
	var arg1 = scr_parseBool(argument0[1], !global.showcollisions);
...
function sh_lock_camera(argument0)
{
	with (obj_camera)
	{
		var arg1 = scr_parseBool(argument0[1], !cameraLock);
		cameraLock = arg1;
	}
}
...
{
	var arg1 = scr_parseBool(argument0[1], !global.showtiles);
...
{
	var arg1 = scr_parseBool(argument0[1], !global.DebugVisuals);
...
function meta_instance_create()
{
	return 
	{
		...
		suggestions: [global.ObjectNameList, 0, 1],
...
function sh_noclip()
{
	if (obj_parent_player.state != 76)
		obj_parent_player.state = 76;
	else
...
{
	if (obj_parent_player.state != 94)
		obj_parent_player.state = 94;
	else
		obj_parent_player.state = 1;
}
