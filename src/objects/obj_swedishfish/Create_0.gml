...
{
	if (scr_enemy_playerisnear(400, 60) && state == 0 && enemyAttackTimer <= 0)
	{
...
enemyState_Attack = function()
{
	...
	if (place_meeting_collision(x + image_xscale, y, 1) || (place_meeting(x + image_xscale, y, obj_clutterCone) && !place_meeting(x, y, obj_clutterCone)))
		wall_check = true;
