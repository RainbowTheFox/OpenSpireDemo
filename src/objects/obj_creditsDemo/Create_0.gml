...
creditEntry = function() constructor
{
	...
	static draw = function()
	{
		...
		with (object_id)
		{
			...
			if (flash)
				...
				draw_player_sprite_ext(sprite_index, image_index, x, y, image_xscale, image_yscale, image_angle, image_blend, image_alpha, 0, 2);
			else
				draw_self();
		}
	...
	static addPaintTopper = function(argument0)
	{
		...
		{
			var sp = new subSprite(spr_paintertopper, argument0[i], 0, false);
			sp.image_xscale = 3;
			sp.image_yscale = 3;
			sp.visible = false;
