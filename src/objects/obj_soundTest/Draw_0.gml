...
var bonus = ["Aw, Fudge! (Bonus) - Pteracotta", "Fudge It All! (Bonus) - RodMod", "what the fudge? it's a secret! (Bonus) - Various", "Run the Dog (Bonus) - PaperKitty", "Sugarcube Hailstorm (Bonus) - PaperKitty", "Painter's Theme (Bonus) - CableChords", "What's that Smell? (Bonus) - PaperKitty", "Painter's Brain - Stewart Keller", "Painter's Mixtape - Stewart Keller", "Samba de Spire - PaperKitty"];
