...
updateEffectPosition = function()
{
	...
	else if (playerID.state == 61 || playerID.sprite_index == spr_player_PZ_wallJumpCancel || playerID.sprite_index == spr_player_PZ_wallJumpCancel_intro)
	{
		x += (32 * playerID.xscale);
	}
	else if (playerID.state == 12)
	{
